...
#Done!
tobereplaced = ['[FULLNAME]', '[SERVERNAME]']
replacements = ['', '']
...
class Mailer:
    ...
    def processusername(self, username):
        try:
            with open('/home/s1309773/SE/GPUScheduling-master/Mailer/custommails', 'r') as m:
                for line in m:
                    helptext = line.split()
                    if(len(helptext) < 2):
                        break
